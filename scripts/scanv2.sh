...
# -----------------------------------
# Pri 3:
# #12  - Add unicorn scan capability
# #13  - Add zmap scan capability
# -----------------------------------
# Review:
# #16  - Stop tcpdumps on workers
# #14  - SSH to worker and start tcpdump
# #11  - Add function changing ongoing to complete
# #15  - Start scan from scanner host
# -----------------------------------
...
# -----------------------------------
# Find target subnet NIC for each worker (terminology: target host in this case when used to receive scans)
# -----------------------------------
